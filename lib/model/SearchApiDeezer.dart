...
SearchApiDeezer welcomeFromJson(String str) =>
    SearchApiDeezer.fromJson(json.decode(str));

String welcomeToJson(SearchApiDeezer data) => json.encode(data.toJson());

class SearchApiDeezer {
  List<ListDataSearch> data;
  int total;
  String next;
  ...
  factory SearchApiDeezer.fromJson(Map<String, dynamic> json) =>
      SearchApiDeezer(
        data: List<ListDataSearch>.from(
            json["data"].map((x) => ListDataSearch.fromJson(x))),
        total: json["total"],
        next: json["next"],
      );
...
class ListDataSearch {
  ...
  factory ListDataSearch.fromJson(Map<String, dynamic> json) => ListDataSearch(
        id: json["id"],
